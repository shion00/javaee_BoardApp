...
public class BoardWrite extends Page{
	...
	JScrollPane scroll;
	JButton bt;
	NoticeDAO noticeDAO;//CRUD 전담객체 보유 has a
	...
	public BoardWrite(BoardMain boardMain) {
		...
		bt.addActionListener((e)->{
			...
			Notice notice=new Notice();//empty 객체 생성
			...
			if(result==0) {
				JOptionPane.showInternalMessageDialog(BoardWrite.this, "등록실패");
			}else {
				JOptionPane.showInternalMessageDialog(BoardWrite.this, "등록성공");
