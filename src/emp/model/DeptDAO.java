...
public class DeptDAO {
	//DAO 에서 SQL문에 들어있는 xml을 호출하자!!, 이때 어떤 쿼리수행을 원하는 지를 구분하기 위해서는 xml 태그에 부여한 id를 이용하면 된다.
	//xml 태그를 호출하기 위해서는 mybatis의 SqlSession이 필요하고, 현재는 MybatisManager 클래스의 멤버로 SqlSessionFactory를 두었다.
